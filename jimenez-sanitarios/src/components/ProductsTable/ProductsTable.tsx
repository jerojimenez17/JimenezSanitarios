    ...
    <Table style={{ }}>
      ...
      <TableHead>
        <TableRow sx={{borderBottom:"3px solid blue"}}>
          <TableCell style={{borderBottom: 2,borderBottomColor:"#f09", fontSize: '1.5rem', fontWeight: '700'}}>Codigo</TableCell>
          <TableCell style={{border: '#f09', fontSize: '1.5rem', fontWeight: '700' }}>Descripcion</TableCell>
          <TableCell  style={{border: '#f09', fontSize: '1.5rem', fontWeight: '700'}}>Marca</TableCell>
          <TableCell style={{border: '#f09', fontSize: '1.5rem', fontWeight: '700'}}>Precio</TableCell>
          <TableCell  style={{ fontSize: '1.5rem', fontWeight: '700'}}/> {/* This is used to show bottons on rows */}
        </TableRow>
      </TableHead>
      <TableBody>
        {/* 
